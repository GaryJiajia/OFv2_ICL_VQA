...
class VQAEval:
    def __init__(self, vqa, vqaRes,  metric_type, n=2):
        self.n = n
        self.accuracy = {}
        self.evalQA = {}
        self.evalQuesType = {}
    ...
    def evaluate(self, quesIds=None):
        ...
        for quesId in quesIds:
            ...
            if self.metric_type == 0:
                ...
                acc = 0
                for gtAnsDatum in gts[quesId]["answers"]:
                    if resAns == gtAnsDatum["answer"]:
                        acc = acc + 1
                if acc >= self.metric_type:
                    avgGTAcc = 1
                else: avgGTAcc = acc/len(gts[quesId]["answers"])
...
def compute_vqa_accuracy(result_json_path, question_json_path, annotation_json_path,  metric_type):
    ...
    vqaEval = VQAEval(vqa, vqaRes,  metric_type, n=2)
