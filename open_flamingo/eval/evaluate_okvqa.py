...
import re
def postprocess_vqa_declaration_generation(predictions):
    answer = re.split("Question|Answer|Short|Caption|Output|Declaration|Declarative|Sentence|Mask", predictions, 1)[0]
