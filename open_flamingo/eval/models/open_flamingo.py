...
class EvalModel(BaseEvalModel):
    ...
    def get_vqa_declaration_prompt(self, question, answer=None) -> str:
        return f"<image>Caption:{question} mask:{answer if answer is not None else ''}{'<|endofchunk|>' if answer is not None else ''}"
